...
use stenvdb\umami\assetbundles\toppageswidget\TopPagesWidgetAsset;
...
class TopPages extends Widget
{
    ...
    {
        return Craft::t('umami', 'Umami Top Pages');
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'umami/_components/widgets/top-pages/settings',
            [
    ...
    public function getBodyHtml()
    {
        ...
        Craft::$app->getView()->registerJs("new window.Umami.TopPagesWidget(".json_encode($settings).");");

        return Craft::$app->getView()->renderTemplate(
            'umami/_components/widgets/top-pages/body', [
                'settings' => $this->getSettings(),
            ]
        );
    }
